...
*/
        ...
        players[list.get(i)] = new Player(sharedData.clientHandlers.get(i).getNAME(), Character.DRLECTER);
        players[list.get(i)].setMafia();
        i++;

        players[list.get(i)] = new Player(sharedData.clientHandlers.get(i).getNAME(), Character.GODFOTHER);
        players[list.get(i)].setMafia();
        i++;
